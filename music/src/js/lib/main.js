$(document).ready(function() {
    $.ajax({
            ...
            url: "http://localhost:8088/liuzhaozhao1910/music/lib/main.php",
            dataType: "json",
            ...
            $.each(datali, function(index, value) {
                ...
                <div>
                    ...
                    <a class="cover f-pr f-blk j-statistics"  <a href="http://localhost:8088/liuzhaozhao1910/music/src/html/goos.html?goodsId=${value.sid}">
                ...
                <div>
                    ...
                    <a class="cover f-pr f-blk "  <a href="http://localhost:8088/liuzhaozhao1910/music/src/html/goos.html?goodsId=${value.sid}"S>
    ...
    $('.shopcar').on('click', function() {
        window.location.href = "http://localhost:8088/liuzhaozhao1910/music/src/html/car.html"
    })
